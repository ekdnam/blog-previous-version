...
I’ve been thinking a lot about AI lately—not just the models or the breakthroughs, but how it all fits into the real world. Last October, I was at an Italian restaurant in San Francisco when I bumped into one of the cofounders of Cursor, an AI-powered code editor I use daily. We chatted a while, and as we spoke, I couldn’t help but wonder: why do some AI tools stick while others fade away? Cursor had been my go-to for months, but just days later, I saw a wave of developers on Twitter raving about Windsurf, a new tool with a slicker interface. It made me realize something unsettling: in the AI space, loyalty is fragile. People chase what’s best, and “best” changes fast.
